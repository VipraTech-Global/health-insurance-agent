# Entity catalogue — proposed revision 17

Batches 1 through 8 are approved. Batch 9 retains only `Calculation`; actual customer claims are outside application scope.
