# Complete application field dictionary — proposed revision 19

Batches 1 through 12 are approved for the buyer-focused adviser. Later batches and the complete design remain under review.

Synthetic examples explain representation only and are not customer records or policy facts.
...
| outcome | enum required | none | Buyer-advice result state Allowed: completed,conditional,clarification_required,insufficient_evidence. | completed,conditional,clarification_required,insufficient_evidence | None | No authentic field value established in reviewed evidence; synthetic examples only in worked-examples.md. | ["DEC-01", "RET-01"] |
...
| selection_sha256 | char(64) required | none | Canonical fingerprint distinguishing two selections of the same variant | SHA-256 of canonical evaluated_selection and schema version | None | Synthetic design example only; no real customer value inspected. | ["DEC-01", "OPS-06"] |
| disposition | enum required | none | How this candidate finished the comparison Allowed: recommended,alternative,eligible,excluded,conditional,insufficient_evidence. | recommended,alternative,eligible,excluded,conditional,insufficient_evidence | None | Synthetic design example only; no real customer value inspected. | ["INS-01", "INS-02", "DEC-01"] |
...
| outcome | enum required | none | Whether the policy satisfies the requirement Allowed: meets,partly_meets,does_not_meet,unknown,not_applicable. | meets,partly_meets,does_not_meet,unknown,not_applicable | None | Synthetic design example only; no real customer value inspected. | ["INS-01", "INS-02", "DEC-01"] |
...
| need_kind | enum required | none | Kind of information required Allowed: fact,requirement,document_confirmation. | fact,requirement,document_confirmation | None | Synthetic design example only; no real customer value inspected. | ["CUS-02", "CUS-03"] |
...
| priority | enum required | none | How much the gap affects advice Allowed: required,important,optional. | required,important,optional | None | Synthetic design example only; no real customer value inspected. | ["CUS-03", "DEC-01"] |
| status | enum required | open | Progress of this clarification Allowed: open,asked,resolved,waived,unavailable. | open,asked,resolved,waived,unavailable | None | Synthetic design example only; no real customer value inspected. | ["CUS-02", "OPS-02"] |
...
| statement_type | enum required | none | Customer-facing statement category Allowed: customer_context,eligibility,requirement_match,benefit,restriction,price,provider,calculation,limitation,next_step. | customer_context,eligibility,requirement_match,benefit,restriction,price,provider,calculation,limitation,next_step | None | No authentic field value established in reviewed evidence; synthetic examples only in worked-examples.md. | ["DEC-01", "INS-05"] |
...
| support_status | enum required | unverified | Whether this statement has adequate support Allowed: supported,partly_supported,unsupported,customer_profile_supported. | supported,partly_supported,unsupported,customer_profile_supported | None | No authentic field value established in reviewed evidence; synthetic examples only in worked-examples.md. | ["DEC-01", "INS-05"] |
