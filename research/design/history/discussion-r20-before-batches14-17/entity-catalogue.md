# Entity catalogue — proposed revision 20
...
| Turn | One durable, idempotent and cancellable customer-message processing request. | private | 14 | conversation_id → Conversation; input_message_id → Message; owner_id → Account; profile_revision_id → CustomerProfileRevision |
