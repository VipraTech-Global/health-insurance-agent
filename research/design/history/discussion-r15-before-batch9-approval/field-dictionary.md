# Field dictionary — proposed revision 15

Batches 1 through 8 are approved. Later batches and the complete database design remain under review.
...
| provider_location_id | fk:ProviderLocation optional | NULL | Exact treating facility branch | None | No authentic field value established in reviewed evidence; synthetic examples only in worked-examples.md. | ["INS-06", "CAL-02", "CAL-03"] |
