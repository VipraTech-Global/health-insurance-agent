# CoverGuide — database design, revision 8 under staged review

**Approval status: Batch 1 (account, people and conversation storage) was explicitly approved by the user on 2026-09-11. Remaining batches and the complete design are still under review; nothing has been implemented.** This is the consolidated database proposal, including the field catalogue, relationships, conditional-rule contracts, retrieval operations, lifecycle and migration mapping. It incorporates the current assessment of all 400 cases and nine additional original-derived cases.
...
The application catalogue contains **100 entities, 1,020 fields, 323 foreign-key relationships and 52 versioned JSON structures**. The separately administered benchmark proposal contains **36 entities, 398 fields and 28 JSON contracts**. These are catalogue sizes, not measures of advice accuracy or insurance coverage.
...
| What does every field mean? | [Readable field dictionary](field-dictionary.md), [typed dictionary](entity-field-dictionary.json), [field traceability](field-traceability-r8.json) |
