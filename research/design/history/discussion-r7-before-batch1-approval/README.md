# CoverGuide database proposal — final proposed revision 7
...
| What does every field mean? | [Field traceability](field-traceability-r7.json), [physical storage/constraints](storage-and-constraints.md), [Readable field dictionary](field-dictionary.md), [complete typed dictionary with units, examples and traceability](entity-field-dictionary.json) |
...
| What has actually been verified? | [Current final-package verification](../reports/final-design-verification-r7.json), [current source dependencies](../reports/source-completion-dependencies-r22.json), [database review](../reports/database-proposal-review-r6.json) |
