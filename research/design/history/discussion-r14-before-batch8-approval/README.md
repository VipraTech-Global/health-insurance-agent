# CoverGuide database proposal — revision 14 under staged review
...
| What does every field mean? | [Field traceability](field-traceability-r14.json), [physical storage/constraints](storage-and-constraints.md), [Readable field dictionary](field-dictionary.md), [complete typed dictionary with units, examples and traceability](entity-field-dictionary.json) |
...
| What has actually been verified? | [Current staged-design verification](../reports/final-design-verification-r14.json), [current source dependencies](../reports/source-completion-dependencies-r22.json), [database review](../reports/database-proposal-review-r6.json) |
