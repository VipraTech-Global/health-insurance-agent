# CoverGuide database proposal — revision 12 under staged review
...
| What does every field mean? | [Field traceability](field-traceability-r12.json), [physical storage/constraints](storage-and-constraints.md), [Readable field dictionary](field-dictionary.md), [complete typed dictionary with units, examples and traceability](entity-field-dictionary.json) |
...
| What has actually been verified? | [Current staged-design verification](../reports/final-design-verification-r12.json), [current source dependencies](../reports/source-completion-dependencies-r22.json), [database review](../reports/database-proposal-review-r6.json) |
...
erDiagram
    ...
    CustomerPolicy ||--o{ CoverageLayer : partitions
...
| Product and issued cover | Product is a stable family, PolicyVersion is the applicable legal terms package, and PolicyVersionDocument links all governing originals. ProductVariant stores insurer-defined base choices and ProductOption stores available additions. CustomerPolicy and CustomerPolicyRevision describe actual owned cover; PolicyMember, IndividualTerm, CoverageLayer, ContinuityCredit and PolicyEvent retain personal membership, underwriting, amount layers and history. |
