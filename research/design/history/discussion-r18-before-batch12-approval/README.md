# CoverGuide database proposal — revision 18 under staged review
...
| What does every field mean? | [Field traceability](field-traceability-r18.json), [physical storage/constraints](storage-and-constraints.md), [Readable field dictionary](field-dictionary.md), [complete typed dictionary with units, examples and traceability](entity-field-dictionary.json) |
...
| What has actually been verified? | [Current staged-design verification](../reports/final-design-verification-r18.json), [current source dependencies](../reports/source-completion-dependencies-r22.json), [database review](../reports/database-proposal-review-r6.json) |
...
| Saved answers and retrieval | Decision and DecisionClaim retain scoped outcomes pending their buyer-focused review; ClaimCitation resolves their originals. KnowledgeRelease, KnowledgeReleaseRule and KnowledgeChannel publish the exact usable rule set. PolicySearchChunk is a replaceable derivative. Recommendation lineage will use direct typed relationships reviewed with the recommendation batch. |
