# Entity catalogue — proposed revision 18

Batches 1 through 11 are approved for the health-insurance buying and comparison adviser. Later batches and the complete design remain under review.
...
| Decision | Validated adviser outcome for exact inputs and evidence. | private | 15 | advice_request_id → AdviceRequest; conversation_id → Conversation; knowledge_release_id → KnowledgeRelease; owner_id → Account; profile_revision_id → CustomerProfileRevision; supersedes_id → Decision; turn_id → Turn |
