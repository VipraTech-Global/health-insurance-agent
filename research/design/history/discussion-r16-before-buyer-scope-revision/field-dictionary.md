# Complete application field dictionary — proposed revision 16

Batches 1 through 9 are approved. Later batches and the complete database design remain under review.
...
| created_at | timestamptz required | transaction timestamp at insertion | When this row was first recorded | instant | No authentic field value established in reviewed evidence; synthetic examples only in worked-examples.md. | ["OPS-06"] |
| facility_name | varchar(300) required | none | Printed name of the exact facility or branch | None | No authentic field value established in reviewed evidence; synthetic examples only in worked-examples.md. | ["OBS-02"] |
| organization_name | varchar(250) optional | NULL | Parent healthcare organization when separately established | None | No authentic field value established in reviewed evidence; synthetic examples only in worked-examples.md. | ["OBS-02"] |
...
| external_identifiers | json:IdentifiersV1 required | empty array | Insurer or registry branch identifiers with provenance | None | No authentic field value established in reviewed evidence; synthetic examples only in worked-examples.md. | ["OBS-02"] |
...
| supersedes_id | fk:ProviderLocation optional | NULL | Earlier branch identity corrected by this immutable row | None | Synthetic identity correction only; no invented provider identity. | ["OBS-02", "OPS-06"] |
...
| id | uuid required | uuid4 for new records; preserve original UUID during migration | Stable row identity | None | No authentic field value established in reviewed evidence; synthetic examples only in worked-examples.md. | ["OBS-02"] |
| created_at | timestamptz required | transaction timestamp at insertion | When this row was first recorded | instant | No authentic field value established in reviewed evidence; synthetic examples only in worked-examples.md. | ["OPS-06"] |
| insurer_id | fk:Insurer required | none | Insurer whose provider network or exclusion source was checked | None | No authentic field value established in reviewed evidence; synthetic examples only in worked-examples.md. | ["OBS-02", "INS-05"] |
| product_variant_id | fk:ProductVariant optional | NULL | Product-specific or restricted network variant when the source establishes one | None | No authentic field value established in reviewed evidence; synthetic examples only in worked-examples.md. | ["OBS-02", "INS-05"] |
| source_capture_id | fk:SourceCapture required | none | Preserved directory, PDF, API response or failed retrieval attempt | None | No authentic new network capture invented for the design. | ["OBS-02", "INS-04", "OPS-03"] |
| scope | json:ProviderNetworkScopeV1 required | none | Exact geography, network tier, service and query filters checked | None | Synthetic design fixture only; authentic personal value unavailable/uninspected. | ["OBS-02"] |
| observed_at | instant required | none | When the provider status was checked or represented | instant | No authentic field value established in reviewed evidence; synthetic examples only in worked-examples.md. | ["OBS-02", "INS-05"] |
| completeness | enum required | unknown | What absence from this exact result can establish Allowed: complete_for_scope,partial,unknown,failed. | None | No authentic completeness claim established; examples are synthetic. | ["OBS-02", "OPS-03"] |
| scope_evidence_id | fk:EvidenceSpan optional | NULL | Exact heading or source statement establishing the snapshot scope | None | No authentic field value established; synthetic scope examples only. | ["OBS-02", "INS-04"] |
...
| id | uuid required | uuid4 for new records; preserve original UUID during migration | Stable row identity | None | No authentic field value established in reviewed evidence; synthetic examples only in worked-examples.md. | ["OBS-02"] |
| created_at | timestamptz required | transaction timestamp at insertion | When this row was first recorded | instant | No authentic field value established in reviewed evidence; synthetic examples only in worked-examples.md. | ["OPS-06"] |
| provider_network_snapshot_id | fk:ProviderNetworkSnapshot required | none | Exact dated insurer directory or list containing this entry | None | Synthetic snapshot reference only. | ["OBS-02", "INS-04"] |
| provider_location_id | fk:ProviderLocation required | none | Exact hospital or healthcare-facility branch | None | No authentic field value established in reviewed evidence; synthetic examples only in worked-examples.md. | ["OBS-02", "INS-05"] |
| network_status | enum required | none | Status explicitly represented by the source Allowed: network,restricted,excluded,unknown. | None | Synthetic status only; no current hospital status asserted. | ["OBS-02"] |
| restrictions | json:NetworkRestrictionsV1 required | none | Entry-specific service, tier or other restrictions, including explicit none or unknown | None | Synthetic restriction structure only. | ["OBS-02", "INS-04"] |
| effective_from | date optional | NULL | Source-stated first applicable date | calendar date | No authentic date established for a provider entry. | ["OBS-02"] |
| effective_to | date optional | NULL | Source-stated last applicable date | calendar date | No authentic date established for a provider entry. | ["OBS-02"] |
| evidence_span_id | fk:EvidenceSpan required | none | Exact directory row or exclusion-list passage | None | No authentic field value established in reviewed evidence; synthetic examples only in worked-examples.md. | ["OBS-02", "INS-05"] |
...
| product_variant_id | fk:ProductVariant required | none | Public product variant used for the quote | None | No authentic field value established in reviewed evidence; synthetic examples only in worked-examples.md. | ["OBS-01", "INS-03"] |
...
| insurer_quote_reference | varchar(200) optional | NULL | Issuer quote reference where supplied | None | No authentic field value established in reviewed evidence; synthetic examples only in worked-examples.md. | ["OBS-01", "INS-03"] |
...
| price_breakdown | json:QuotePriceBreakdownV1 required | none | Closed ordered base, option, loading, discount, tax and fee breakdown | None | Synthetic breakdown only; no customer quote invented. | ["OBS-01", "CAL-01", "INS-04"] |
| payment_schedule | json:QuotePaymentScheduleV1 required | none | Quoted instalment amounts and dates or explicit unavailable state | None | Synthetic schedule only; no customer quote invented. | ["OBS-01", "CAL-01", "INS-04"] |
| source_evidence_id | fk:EvidenceSpan required | none | Exact private insurer quote evidence | None | No real customer quote evidence inspected. | ["OBS-01", "INS-04", "OPS-01"] |
...
One reported, documented or hypothetical medical event for one person.

| Field | Type / required | Default | Purpose | Units | Example | Basis |
|---|---|---|---|---|---|---|
| id | uuid required | uuid4 for new records; preserve original UUID during migration | Stable row identity | None | Synthetic design example only; no real customer value included. | ["INS-06", "CAL-02", "CAL-03"] |
| created_at | timestamptz required | transaction timestamp at insertion | When this row was first recorded | instant | Synthetic design example only; no real customer value included. | ["OPS-06"] |
| owner_id | fk:Account required | none | Account whose authorization governs this private row | None | Intentionally no real customer or authentication identity included. | ["OPS-01"] |
| person_id | fk:Person required | none | Person receiving treatment | None | Synthetic design example only; no real customer value included. | ["INS-06", "CAL-02", "CAL-03"] |
| provider_location_id | fk:ProviderLocation optional | NULL | Exact treating facility branch when known | None | Synthetic design example only; no real customer value included. | ["INS-06", "CAL-02", "CAL-03"] |
| treatment_period | json:TemporalExtentV1 required | none | Treatment or admission interval with its actual precision | None | Synthetic design example only; no real customer value included. | ["INS-06", "CAL-02", "CAL-03"] |
| setting | enum required | unknown | Treatment setting Allowed: inpatient,daycare,outpatient,home,ayush,unknown. | None | inpatient (synthetic) | ["INS-06", "CAL-02", "CAL-03"] |
| clinical_fact_ids | json:UuidListV1 required | [] | Exact CustomerFact records describing diagnosis, procedure and relevant circumstances | None | Synthetic references to cataract diagnosis and procedure facts. | ["INS-06", "CAL-02", "CAL-03"] |
| information_basis | enum required | reported | Whether the episode is customer-reported, document-backed or hypothetical Allowed: reported,documented,hypothetical. | None | documented (synthetic) | ["CUS-02", "INS-06", "CAL-02"] |
| source_evidence_id | fk:EvidenceSpan optional | NULL | Exact private medical-document passage supporting the episode | None | Synthetic design example only; no real customer value included. | ["INS-06", "CAL-02", "CAL-03"] |
| supersedes_id | fk:TreatmentEpisode optional | NULL | Earlier incorrect episode record replaced by this one | None | Synthetic design example only; no real customer value included. | ["CUS-02", "CAL-03"] |

Constraints: unique(id,owner_id); owner_id immutable; person_id and private evidence share owner_id; known treatment interval is nonempty and temporally ordered; information_basis=documented requires source_evidence_id; supersedes_id is same-owner, same-person, acyclic and unique where nonnull; records used by an assessment are immutable; corrections append a successor

Indexes: owner_id,person_id,created_at DESC; provider_location_id; supersedes_id unique where nonnull; GIN clinical_fact_ids

## TreatmentExpense

One billed, reported or hypothetical expense within a treatment episode.

| Field | Type / required | Default | Purpose | Units | Example | Basis |
|---|---|---|---|---|---|---|
| id | uuid required | uuid4 for new records; preserve original UUID during migration | Stable row identity | None | Synthetic design example only; no real customer value included. | ["CAL-02", "CAL-03"] |
| created_at | timestamptz required | transaction timestamp at insertion | When this row was first recorded | instant | Synthetic design example only; no real customer value included. | ["OPS-06"] |
| owner_id | fk:Account required | none | Account whose authorization governs this private row | None | Intentionally no real customer or authentication identity included. | ["OPS-01"] |
| treatment_episode_id | fk:TreatmentEpisode required | none | Medical event containing this expense | None | Synthetic design example only; no real customer value included. | ["CAL-02", "CAL-03"] |
| description | text required | none | Bill wording or customer description | None | Private room charges (synthetic) | ["CAL-02", "CAL-03"] |
| expense_type | enum required | unknown | Structured expense category used by policy rules Allowed: room,icu,procedure,medicine,implant,diagnostic,consultation,ambulance,consumable,other,unknown. | None | room (synthetic) | ["CAL-02", "CAL-03"] |
| service_period | json:TemporalExtentV1 required | none | When the charged service was provided | None | Synthetic design example only; no real customer value included. | ["CAL-02", "CAL-03"] |
| billed_amount | json:QuantityV1 required | none | Gross amount charged | None | INR 20000 (synthetic) | ["CAL-02", "CAL-03"] |
| quantity | json:QuantityV1 optional | NULL | Billed days, items or other units when stated | None | 2 day (synthetic) | ["CAL-02", "CAL-03"] |
| allocations | json:TreatmentExpenseAllocationsV1 required | [] | Optional structured portions when one expense contains several categories or periods | None | Synthetic design example only; no real customer value included. | ["CAL-02", "CAL-03"] |
| source_evidence_id | fk:EvidenceSpan optional | NULL | Exact private bill or medical-document passage supporting the expense | None | Synthetic design example only; no real customer value included. | ["CAL-02", "CAL-03"] |
| supersedes_id | fk:TreatmentExpense optional | NULL | Earlier incorrect expense record replaced by this one | None | Synthetic design example only; no real customer value included. | ["CUS-02", "CAL-03"] |

Constraints: unique(id,owner_id); owner_id immutable; treatment_episode_id and private evidence share owner_id; finite billed and allocated amounts are nonnegative money in one currency; known nonoverlapping allocations sum to no more than billed_amount; supersedes_id is same-owner, same-episode, acyclic and unique where nonnull; records used by an assessment are immutable; corrections append a successor

Indexes: treatment_episode_id,created_at; owner_id,expense_type; supersedes_id unique where nonnull; GIN allocations

## CoverageAssessment

One evaluation of a treatment against either an issued customer policy revision or a prospective product selection.

| Field | Type / required | Default | Purpose | Units | Example | Basis |
|---|---|---|---|---|---|---|
| id | uuid required | uuid4 for new records; preserve original UUID during migration | Stable row identity | None | Synthetic design example only; no real customer value included. | ["CAL-02", "CAL-03", "DEC-01"] |
| created_at | timestamptz required | transaction timestamp at insertion | When this row was first recorded | instant | Synthetic design example only; no real customer value included. | ["OPS-06"] |
| owner_id | fk:Account required | none | Account whose authorization governs this private row | None | Intentionally no real customer or authentication identity included. | ["OPS-01"] |
| advice_request_id | fk:AdviceRequest required | none | Customer question this assessment helps answer | None | Synthetic design example only; no real customer value included. | ["CUS-03", "CAL-02", "DEC-01"] |
| profile_revision_id | fk:CustomerProfileRevision required | none | Exact accepted customer facts and requirements evaluated | None | Synthetic design example only; no real customer value included. | ["CUS-02", "CAL-02", "DEC-01"] |
| treatment_episode_id | fk:TreatmentEpisode required | none | Treatment being evaluated | None | Synthetic design example only; no real customer value included. | ["CAL-02", "CAL-03"] |
| customer_policy_revision_id | fk:CustomerPolicyRevision optional | NULL | Exact issued customer policy when assessing existing cover | None | Synthetic design example only; no real customer value included. | ["INS-03", "CAL-02", "CAL-03"] |
| product_variant_id | fk:ProductVariant optional | NULL | Candidate public product variant for a prospective assessment | None | Synthetic design example only; no real customer value included. | ["INS-03", "INS-05", "CAL-02"] |
| prospective_selection | json:AcceptedSelectionV1 optional | NULL | Proposed people, options, sum insured, deductible and other choices | None | Synthetic design example only; no real customer value included. | ["INS-03", "INS-05", "CAL-02"] |
| as_of_date | date required | none | Date on which policy and customer applicability are evaluated | calendar date | Synthetic design example only; no real customer value included. | ["INS-02", "INS-05", "CAL-02"] |
| outcome_status | enum required | pending | Whether the coverage evaluation is usable Allowed: pending,complete,conditional,insufficient_evidence. | None | complete (synthetic) | ["CAL-02", "DEC-01"] |
| calculation_id | fk:Calculation optional | NULL | Deterministic calculation producing this assessment | None | Synthetic design example only; no real customer value included. | ["CAL-02", "CAL-03", "DEC-01"] |

Constraints: unique(id,owner_id); owner_id immutable; all private relationships share owner_id; exactly one context branch is present: customer_policy_revision_id, or both product_variant_id and prospective_selection; issued-policy branch derives selections from CustomerPolicyRevision and does not duplicate them; prospective choices must be valid for product_variant_id; complete or conditional requires calculation_id; insufficient evidence keeps unknown inputs explicit; calculation_id belongs to the same AdviceRequest and is immutable once published

Indexes: advice_request_id,created_at DESC; profile_revision_id; treatment_episode_id; customer_policy_revision_id; product_variant_id; owner_id,outcome_status
...
Structured result for one treatment expense within one coverage assessment.
...
| created_at | timestamptz required | transaction timestamp at insertion | When this row was first recorded | instant | Synthetic design example only; no real customer value included. | ["OPS-06"] |
| owner_id | fk:Account required | none | Account whose authorization governs this private row | None | Intentionally no real customer or authentication identity included. | ["OPS-01"] |
| coverage_assessment_id | fk:CoverageAssessment required | none | Parent treatment-versus-policy evaluation | None | Synthetic design example only; no real customer value included. | ["CAL-02", "CAL-03", "DEC-01"] |
| treatment_expense_id | fk:TreatmentExpense required | none | Expense being evaluated | None | Synthetic design example only; no real customer value included. | ["CAL-02", "CAL-03"] |
| status | enum required | unknown | Coverage conclusion for this expense Allowed: admissible,inadmissible,conditional,unknown. | None | inadmissible (synthetic) | ["CAL-02", "CAL-03", "DEC-01"] |
| admissible_amount | json:QuantityV1 required | none | Amount remaining after contractual admissibility rules | None | Synthetic design example only; no real customer value included. | ["CAL-02", "CAL-03"] |
| deductible_contribution | json:QuantityV1 required | none | Amount counted toward the applicable deductible or top-up threshold | None | Synthetic design example only; no real customer value included. | ["CAL-02", "CAL-03", "CAL-04"] |
| cover_consumption | json:QuantityV1 required | none | Amount consuming the applicable cover pool | None | Synthetic design example only; no real customer value included. | ["CAL-02", "CAL-03", "CAL-04"] |
| payable_amount | json:QuantityV1 required | none | Expected insurer liability for this expense under the evaluated assumptions | None | Synthetic design example only; no real customer value included. | ["CAL-02", "CAL-03", "DEC-01"] |
| calculation_step_keys | json:StringListV1 required | [] | Exact parent-calculation steps explaining this result | None | Synthetic design example only; no real customer value included. | ["CAL-02", "CAL-03", "DEC-01"] |

Constraints: unique(coverage_assessment_id,treatment_expense_id); unique(id,owner_id); owner_id immutable; assessment, expense and private relationships share owner_id; treatment_expense belongs to the assessment TreatmentEpisode; finite amounts are nonnegative money in the calculation currency; complete monetary fields are replayable from named calculation steps; payable_amount is expected liability, not evidence of insurer payment

Indexes: coverage_assessment_id,status; treatment_expense_id; owner_id,status
...
| expense_coverage_result_id | fk:ExpenseCoverageResult optional | NULL | Coverage result causing this proposed usage posting | None | No authentic field value established in reviewed evidence; synthetic examples only in worked-examples.md. | ["CAL-03", "CAL-04", "INS-07"] |
...
| Field | Type / required | Default | Purpose | Units | Example | Basis |
|---|---|---|---|---|---|---|
| id | uuid required | uuid4 for new records; preserve original UUID during migration | Stable row identity | None | Synthetic design example only; no real customer value included. | ["CAL-01", "CAL-02", "CAL-03", "DEC-01"] |
| created_at | timestamptz required | transaction timestamp at insertion | When this row was first recorded | instant | Synthetic design example only; no real customer value included. | ["OPS-06"] |
| owner_id | fk:Account required | none | Account whose authorization governs this private row | None | Intentionally no real customer or authentication identity included. | ["OPS-01"] |
| advice_request_id | fk:AdviceRequest required | none | Customer question requiring this calculation | None | Synthetic design example only; no real customer value included. | ["CAL-01", "CAL-02", "DEC-01"] |
| calculation_type | varchar(120) required | none | Reviewed calculation kind used to select the deterministic evaluator | None | claim_payable_amount (synthetic) | ["CAL-01", "CAL-02", "CAL-03", "CAL-04"] |
| engine_version | varchar(120) required | none | Exact qualified deterministic evaluator build | None | claim-engine-1.0 (synthetic) | ["CAL-01", "CAL-02", "CAL-03", "OPS-06"] |
| inputs | json:CalculationInputsV1 required | none | Exact values, units and record/evidence references used | None | Synthetic design example only; no real customer value included. | ["CAL-01", "CAL-02", "CAL-03", "DEC-01"] |
| operations | json:CalculationOperationsV1 required | none | Ordered typed operations with intermediate results and policy support | None | Synthetic design example only; no real customer value included. | ["CAL-01", "CAL-02", "CAL-03", "CAL-04", "DEC-01"] |
| result | json:TypedValueV1 required | none | Final computed value or explicit unknown/not-applicable result | None | Synthetic design example only; no real customer value included. | ["CAL-01", "CAL-02", "CAL-03", "DEC-01"] |
| assumptions | json:AssumptionsV1 required | [] | Material hypothetical or unresolved premises | None | Synthetic design example only; no real customer value included. | ["CAL-01", "CAL-02", "DEC-01"] |
| status | enum required | none | Whether deterministic evaluation completed Allowed: complete,blocked,failed. | None | complete (synthetic) | ["CAL-01", "CAL-02", "DEC-01"] |
