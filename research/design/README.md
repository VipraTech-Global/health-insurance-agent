...
Revision `discussion-r25-final-review` and the route-pinning amendment were explicitly approved for local implementation on 2026-09-22. Production deployment, benchmark freeze and cutover remain unapproved.

The application design contains **63 custom models, 601 fields, 170 typed foreign-key relationships and 31 closed JSON definitions**. Django-managed framework tables are listed in [django-managed-tables.md](django-managed-tables.md). The physically separate benchmark proposal contains **24 models, 296 fields, 39 internal foreign keys and 12 closed payload contracts**.
