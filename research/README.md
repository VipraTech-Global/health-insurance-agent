...
The [database design, revision 8 under staged review](design/FINAL_DATABASE_DESIGN.md), is assembled for detailed discussion. The requested full original-backed assessment and source reconciliation remain **unfinished**; their unresolved dependencies are preserved explicitly. Batch 1 is explicitly approved; the complete replacement design is not yet approved; no replacement models, migrations, adviser or production cutover have been implemented by this research work.
...
| Database proposal | Revision 8 under staged review: Batch 1 approved; complete design unapproved; 100 entities, 1,020 fields, 323 typed relationships, 52 JSON structures and 28 requirement groups. Separate benchmark store: 36 entities, 398 fields, 28 structures. | [Simple review guide](design/SIMPLE_DATABASE_REVIEW_GUIDE.md), [final proposal](design/FINAL_DATABASE_DESIGN.md), [every field](design/field-dictionary.md), [complete ERD](design/complete-entity-relationships.mmd), [all 400 safe requirement mappings](design/case-requirement-field-map.json) |
